DEFAULT_DATA = {
    # Buttons
    "WebCamStreamDisplay": "text",
    # 'WebCamStreamIconHover': './rope/media/webcam_hover.png',
    # 'WebCamStreamIconOff': './rope/media/webcam_off.png',
    # 'WebCamStreamIconOn': './rope/media/webcam_on.png',
    "WebCamStreamInfoText": "CAMERA STREAM:\nPerforms real-time face swapping on the webcam stream.",
    "WebCamStreamState": False,
    "WebCamStreamText": "Camera Stream",
    ...
    "PreviewModeTextSelModes": ["Video", "Image", "Camera Stream"],
